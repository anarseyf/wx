...
static const unsigned char _cmd_import_sd[8] = {0xA5, 0x00, 0x09, CMD_IMPORT_SD, 0xCC, 0x33, 0xC3, 0x3C}; 				//CMD_IMPORT_SD
...
/*******************************************************************************
 * Function Name  : void epd_import_sd(void)
 * Description    :
 * Input          :
 * Output         : None
 * Return         :
 * Attention		   : None
 *******************************************************************************/
void epd_import_sd(void)
{
    memcpy(_cmd_buff, _cmd_import_sd, 8);
    _cmd_buff[8] = _verify(_cmd_buff, 8);
